...
android {
    namespace = "com.tr.helpark.helparkcapstoneproject"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.tr.helpark.helparkcapstoneproject"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Firebase
    val firebaseVersion by extra("32.2.0")
    ...
    // Hilt
    val hiltVersion by extra("2.48.1") // Ensure to replace Your_Hilt_Version_Here with your Hilt version
    implementation("com.google.dagger:hilt-android:$hiltVersion")
    kapt("com.google.dagger:hilt-compiler:$hiltVersion")

    // OkHttp
    val okHttpVersion by extra("5.0.0-alpha.2") // Ensure to replace Your_OkHttp_Version_Here with your OkHttp version
